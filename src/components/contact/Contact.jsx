        ...
        <div className="contact__content">
          ...
          <div className="contact__info">
            <div className="contact__card">
              ...
              <span className="contact__card-data">eswar.tatipaka@gmail.com</span>

              <a href="mailto:eswar.tatipaka@gmail.com" className="contact__button">Write me {" "}<i className="bx bx-right-arrow-alt contact__button-icon"></i></a>
            </div>
            ...
            <div className="contact__card">
              ...
              <span className="contact__card-data">+91-9393654247</span>

              <a href="https://api.whatsapp.com/send?phone=+919393654247&text=Hello!" className="contact__button">Message me {" "}<i className="bx bx-right-arrow-alt contact__button-icon"></i></a>
            </div>
            ...
            <div className="contact__card">
              ...
              <a href="tel:+919393654247" className="contact__button">Call me {" "}<i className="bx bx-right-arrow-alt contact__button-icon"></i></a>
            </div>
          </div>
        </div>
